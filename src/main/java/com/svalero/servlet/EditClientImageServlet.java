...
@WebServlet("/editImageClient")
@MultipartConfig
public class EditClientImageServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            Database.jdbi.withExtension(ClientDAO2.class, dao -> {
                dao.modifyImageClient(fileName, Integer.parseInt(request.getParameter("id")));
                return null;
            });
